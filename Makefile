...
SRC = vendor/single.c vendor/sqlite3.c src/config.c src/database.c src/http.c src/luabind.c src/render.c src/router.c src/socket.c src/ssl.c src/static.c src/util.c src/xml.c #src/json.c src/dirent-filter.c
OBJ = ${SRC:.c=.o}
